...
menu: {
	...
	custom: [ { title: 'Keys', icon: '<i class="fa fa-keyboard">', content: `
  	...
  	themes: [// Specifies the themes that will be available in the themes menu panel. Set to 'true' to show the themes menu panel with the default themes list. 
		...
		{ name: 'zenika-thailand-phang-nga-back', theme: 'themes/css/reveal-zenika-thailand-cheow-lan-back.css' },
		{ name: 'zenika-thailand-phang-nga-shirt', theme: 'themes/css/reveal-zenika-thailand-cheow-lan-shirt.css' },
		{ name: 'zenika-usa-city', theme: 'themes/css/reveal-zenika-usa-city.css' },
