...
menu: {
	...
	custom: [ { title: 'Keys', icon: '<i class="fa fa-keyboard">', content: `
  	...
  	themes: [// Specifies the themes that will be available in the themes menu panel. Set to 'true' to show the themes menu panel with the default themes list. 
		...
		{ name: 'rocher-grass-light', theme: '../../framework/themes/css/reveal-rocher-grass-light.css' },
		...
		{ name: 'zenika-algeria-timgad', theme: '../../framework/themes/css/reveal-zenika-algeria-timgad.css' },
		...
		{ name: 'code-php-dark', theme: '../../framework/themes/css/reveal-code-php-dark.css' },
		{ name: 'containers-dark', theme: '../../framework/themes/css/reveal-containers-dark.css' },
		{ name: 'containers-cargo-blue', theme: '../../framework/themes/css/reveal-containers-cargo-blue.css' },
		{ name: 'rocher-grass-dark', theme: '../../framework/themes/css/reveal-rocher-grass-dark.css' },
